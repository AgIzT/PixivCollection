export const LINK_GITHUB = 'https://github.com/AgIzT/PixivCollection'
...
const MASONRY_COLOR_HUE_SORT_START_ENV = Number(import.meta.env.VITE_MASONRY_COLOR_HUE_SORT_START)
export const MASONRY_COLOR_HUE_SORT_START = Number.isFinite(MASONRY_COLOR_HUE_SORT_START_ENV) ? MASONRY_COLOR_HUE_SORT_START_ENV : 240
